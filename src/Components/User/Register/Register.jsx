    ...
    <div className="flex items-center justify-center min-h-screen m-5 bg-gray-50">
      ...
      <div className="w-full max-w-md p-6 bg-white rounded-md shadow-md">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="mobileNumber" className="block mb-2 text-sm font-bold text-gray-700">
              Mobile Number:
            </label>
            <input
              type="tel"
          ...
          <div className="mb-4">
            <label htmlFor="meterId" className="block mb-2 text-sm font-bold text-gray-700">
              Meter ID:
            </label>
            <input
